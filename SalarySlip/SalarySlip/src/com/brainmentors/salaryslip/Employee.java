...
public class Employee {
	...
	public String printReport() {
		...
		return "Date is "+Formatting.dateFormat()+"\nId is "+id+ "\nName is "+name+"\n"+
				...
				"Basic Salary is "+Formatting.currencyFormat(salary)+"\n"+

				"HRA is "+Formatting.currencyFormat(hra())+"\n"+

				"DA is "+Formatting.currencyFormat(da())+"\n"+

				"GS is "+Formatting.currencyFormat(gs());
